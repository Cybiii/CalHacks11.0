...
import HeroImage from '../pages/images/hero-image.png';
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="pt-16 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="text-center pb-12 md:pb-16">
            <img src='../../public/images/mealprep.png' width={600} className="mx-auto text-5xl md:text-6xl leading-tighter tracking-tighter" data-aos="zoom-y-out" />
            <div className="max-w-6xl mx-auto">
              ...
              <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center" data-aos="zoom-y-out" data-aos-delay="300">
                <div>
                  <a className="btn text-white bg-red-600 hover:bg-red-700 w-full mb-4 sm:w-auto sm:mb-0" href="#0">
                    Sign In
                  </a>
                </div>
                <div>
          ...
          <div className="flex justify-center items-center mb-8" data-aos="zoom-y-out" data-aos-delay="450">
            ...
            >
              ...
              <span className="ml-3">Watch this recipes going (5 min)</span>
            </button>
          </div>
